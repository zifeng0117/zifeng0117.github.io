                    ...
                    <div class="screen__content">
                        ...
                        <form  class="login" action="login.php" method="post">
                            ...
                            <div class="login__field">
                                ...
                                <input type="text" class="login__input" name="username"  placeholder="Username" pattern="[A-Za-z0-9]+" 
                                       title="Please enter only alphanumeric characters" required>
                            </div>
                            <div class="login__field">
                                <i class="login__icon bi bi-lock-fill"></i>
                                <input type="password" class="login__input" name="password" placeholder="Password" minlength="3" maxlength="8" 
                                       pattern=".{3,8}" title="Please enter a password with a minimum of 3 characters" required>
                            </div>  
                            <!-- Register buttons -->
                            <div class="register-text">
                                <a href="register.php" class="text-black-50">Register an account?</a>                
                            </div>
