        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-9 ml-sm-auto col-lg-10 px-md-4" >
                    ...
                    <div class="container">
                        <div class="row">
                            <table class=" table-responsive mt-2 table table-striped table-dark table table-hover">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        foreach ($result as $user) {
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <a href="admineditacc.php?id=<?= $user['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    <form action="action.php" method="POST" class="d-inline" onclick="return confirm('Are you sure want to delete this account?');">
