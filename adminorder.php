                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        foreach ($result as $orders) {
                                            ...
                                            <tr>
                                                ...
                                                <td></td>  
                                                <td>
                                                    <a href="admineditorder.php?id=<?= $orders['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                </td>
                                                <td>
                                                    <form action="action.php" method="POST" class="d-inline" onclick="return confirm('Are you sure want to delete this order?');">
                                                        <button type="submit" name="delete_order" value="<?= $orders['id']; ?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
